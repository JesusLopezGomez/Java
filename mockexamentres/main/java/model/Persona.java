package mockexamentres.main.java.model;
...
public class Persona {
	...
	private boolean validarDatosNombreApellidoDni(String nombre, String apellido, String dni) {
	...
	public boolean validarDatos(String nombre, String apellido, String dni, LocalDate fechaNacimiento, String genero) {
		return validarDatosFechaGenero(fechaNacimiento, genero) && validarDatos(nombre,apellido,dni);
	}

	private boolean validarDatosFechaGenero(LocalDate fechaNacimiento, String genero) {
		boolean resultado = true;
