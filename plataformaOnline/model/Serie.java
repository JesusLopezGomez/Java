...
public class Serie implements Comparable<Serie>{
	...
	public void annadirTemporada( String nombreTemporada) throws SerieException {
		if(!this.temporadas.contains(new Temporada(nombreTemporada))) {
			this.temporadas.add(new Temporada(nombreTemporada));
		}else {
			throw new SerieException("Error esa temporada ya existe");
		}
	...
	public String listadoTemporadasPorNotaMedia() {
		...
		Collections.sort(this.temporadas, new OrdenarTemporadaNotaMediaComparator());
	...
	//Este clase usa Lista porque es importante el orden de los capitulos, y tambien porque nos permite ordenar por los requisitos pedidos en el examen
